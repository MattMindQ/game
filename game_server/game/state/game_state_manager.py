...
class GameStateManager:
    def __init__(self, bounds: tuple):
        ...
        self.state_ids = {
            ...
            AgentState: UUID('00000000-0000-0000-0000-000000000004')
        }
    ...
    def _register_state(self, state_type: Type, state: BaseState) -> None:
        ...
        self.state_manager.register_state(state_type, state.get_value(), state_id)
    ...
    def sync_states(self) -> Dict[str, Any]:
        try:
            ...
            logger.info(f"Synced states: {updates}")
            return updates
        except Exception as e:
